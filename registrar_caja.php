...
<body>
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Venta</span> - Registrar Caja</h4>
						</div>
					...
					<div class="breadcrumb-line breadcrumb-line-component">
						<ul class="breadcrumb">
							...
							<li class="active">Registra Caja</li>
						</ul>
						...
						<div class="col-sm-12">
							<div class="panel panel-primary panel-bordered">
								<div class="panel-heading">
									<h6 class="panel-title">Registrar Caja</h6>
									<div class="heading-elements">
										<ul class="icons-list">
													...
													<div class="collapse in" id="demo1" aria-expanded="true">
														<?php
                                                            if(isset($_GET["update"])){
                                                                ...
                                                                $row = $obj->select_record("ven_caja1",$where);
                                                        ?>
                                                                                                                
                                                        <form action="php/clases/caja.php" method="POST">
                                                            <div class="row">
                                                                <div class="form-group col-sm-6">
                                                                    <label>Ingresar numero:</label>
                                                                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                                                                    <input type="text" class="form-control" value="<?php echo $row["caja_num"]; ?>" name="n_numero" placeholder="Numero de la Caja">
                                                                </div>
                                                                <div class="form-group col-sm-6">
                                                                    <label>Tipo de Caja:</label>
                                                                    <select class="select" name="n_tipocaja">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-sm-6">
                                                                    ...
                                                                    <select class="select" name="n_tipocomprobante">
                                                                        <?php
                                                                        $myrow = $obj->fetch_record("ven_tipo_comprobante");
                                                                ...
                                                                <div class="form-group col-sm-6">
                                                                    ...
                                                                    <select class="select" name="n_estadocaja">
                                                        ...
                                                        <form action="php/clases/caja.php" method="POST">
                                                            <div class="row">
                                                                <div class="form-group col-sm-6">
                                                                    <label>Ingresar numero:</label>
                                                                    <input type="text" class="form-control" name="n_numero" placeholder="Numero de la Caja">
                                                                </div>
                                                                <div class="form-group col-sm-6">
                                                                    <label>Tipo de Caja:</label>
                                                                    <select class="select" name="n_tipocaja">
														...
														<table class="table datatable-basic">
															...
															<tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="registrar_caja.php?update=1&id=<?php echo $row["caja_id"]; ?>" class="btn btn-sm btn-info">Editar</a>
                                                                        <a href="php/clases/caja.php?delete=1&id=<?php echo $row["caja_id"]; ?>" class="btn btn-sm btn-danger">Eliminar</a>
                                                                    </td>
                                                                </tr>
                                                                <?php
                                                                    }
    ...
    <!--<script>
        $(function (e){
            $("#frm_registrar_caja").on('submit',(function(e){
                e.preventDefault();
                $.ajax({
