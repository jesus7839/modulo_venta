<?php
include 'php/clases/tipo_pago.php';
?>
<!DOCTYPE html>
<html lang="es">
<head>
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Venta</span> - Registrar Tipo de Pago</h4>
						</div>
					...
					<div class="breadcrumb-line breadcrumb-line-component">
						<ul class="breadcrumb">
							...
							<li class="active">Registra Tipo de Pago</li>
						</ul>
						...
						<div class="col-sm-12">
							<div class="panel panel-primary panel-bordered">
								<div class="panel-heading">
									<h6 class="panel-title">Registrar Tipo de Pago</h6>
									<div class="heading-elements">
										<ul class="icons-list">
													...
													<div class="collapse in" id="demo1" aria-expanded="true">
                                                        ...
                                                        <?php
                                                            if(isset($_GET["update"])){
                                                                ...
                                                                $row = $obj->select_record("ven_tipo_pago",$where);
                                                        ?>
                                                        <form action="php/clases/tipo_pago.php" method="POST">
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-sm-5">
                                                                    ...
                                                                    <input type="text" class="form-control" value="<?php echo $row["tipg_Cuotas"]; ?>" name="n_referencia">
                                                                </div>
                                                            </div>
														...
														<form action="php/clases/tipo_pago.php" method="POST">
															<div class="row">
																...
																<div class="form-group col-sm-5">
																	<label>Referencia:</label>
																	<input type="text" class="form-control" name="n_referencia">
																</div>
															</div>
															...
															<tbody>
                                                                <?php
                                                                    ...
                                                                    foreach ($myrow as $row) {
                                                                        ...
                                                                        ?>
                                                                            <tr>
                                                                                <td><?php echo $row["tipg_id"]; ?></td>
                                                                                <td><?php echo $row["tipg_Descripcion"]; ?></td>
                                                                                <td><?php echo $row["tipg_Cuotas"]; ?></td>
                                                                                <td>
                                                                                    <a href="registrar_tipo_pago.php?update=1&id=<?php echo $row["tipg_id"]; ?>" class="btn btn-sm btn-info">Editar</a>
                                                                                    <a href="php/clases/tipo_pago.php?delete=1&id=<?php echo $row["tipg_id"]; ?>" class="btn btn-sm btn-danger">Eliminar</a>
                                                                                </td>
                                                                            </tr>
                                                                        <?php
                                                                    }
