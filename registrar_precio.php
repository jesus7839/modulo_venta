				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Venta</span> - Registrar Precio</h4>
						</div>
					...
					<div class="breadcrumb-line breadcrumb-line-component">
						<ul class="breadcrumb">
							...
							<li class="active">Registra Precio</li>
						</ul>
						...
						<div class="col-sm-12">
							<div class="panel panel-primary panel-bordered">
								<div class="panel-heading">
									<h6 class="panel-title">Registrar Precio</h6>
									<div class="heading-elements">
										<ul class="icons-list">
													...
													<div class="collapse in" id="demo1" aria-expanded="true">
                                                        ...
                                                        <?php
                                                            if(isset($_GET["update"])){
                                                                ...
                                                                $row = $obj->select_record("ven_precio",$where);
                                                        ?>
                                                        
                                                        <form action="php/clases/precio.php" method="POST">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-sm-12">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="hidden" id="idproducto" value="<?php echo $row["prod_id"]; ?>" name="n_idproducto"> 
                                                                        <input type="text" class="form-control" value="<?php echo $row["prod_Nom"]; ?>" id="idnombreprod" placeholder="Nombre de Producto">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-sm-6">
                                                                    ...
                                                                    <input type="text" name="n_premayor" value="<?php echo $row["pre_Precioxmayor"]; ?>" class="form-control">
                                                                </div>
                                                                <div class="form-group col-sm-6">
                                                                    <label>Precio por Menor:</label>
                                                                    <input type="text" name="n_premenor" value="<?php echo $row["pre_Precioxunidad"]; ?>" class="form-control">
                                                                </div>
                                                            </div>
														...
														<form action="php/clases/precio.php" method="POST">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-sm-6">
                                                                    <label>Precio por Mayor:</label>
                                                                    <input type="text" name="n_premayor" class="form-control">
                                                                </div>
                                                                <div class="form-group col-sm-6">
                                                                    <label>Precio por Menor:</label>
                                                                    <input type="text" name="n_premenor" class="form-control">
                                                                </div>
                                                            </div>
												...
												<fieldset>
													...
													<div class="collapse in" id="demo2" aria-expanded="true">
														...
														<table class="table datatable-basic">
															...
															<tbody>
                                                                <?php
                                                                    $myrow = $obj->fetch_record("ven_tipo_pago");
                                                                    foreach ($myrow as $row) {
                                                                        ...
                                                                        ?>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <a href="registrar_precio.php?update=1&id=<?php echo $row["pre_id"]; ?>" class="btn btn-sm btn-info">Editar</a>
                                                                                    <a href="php/clases/precio.php?delete=1&id=<?php echo $row["pre_id"]; ?>" class="btn btn-sm btn-danger">Eliminar</a>
                                                                                </td>
                                                                            </tr>
                                                                        <?php
                                                                    }
