				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Venta</span> - Registrar Cliente</h4>
						</div>
						...
						<div class="col-sm-12">
							<div class="panel panel-primary panel-bordered">
								<div class="panel-heading">
									<h6 class="panel-title">Registrar Cliente</h6>
									<div class="heading-elements">
										<ul class="icons-list">
											...
											<div class="tab-pane active" id="justified-label-tab1">
												<fieldset>
													...
													<div class="collapse in" id="demo1" aria-expanded="true">
                                                        ...
                                                        ?>
                                                        <form method="POST" action="php/clases/cliente.php" id="form_cliente">
                                                            <div class="row">
                                                                <div class="form-group col-sm-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-xs-12  col-sm-6">
                                                                    ...
                                                                    <input type="text" class="form-control" name="n_apepat">
                                                                </div>
                                                                <div class="form-group col-xs-12 col-sm-6">
                                                                    <label>Ingresar Apellido Materno:</label>
                                                                    <input type="text" class="form-control" name="n_apemat">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-xs-12 col-sm-6">
                                                                    ...
                                                                    <input type="text" class="form-control" name="n_direccion">
                                                                </div>
                                                                <div class="form-group col-xs-12 col-sm-6">
                                                                    <label>Email:</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-xs-12 col-sm-12 col-md-6">
                                                                    <label class="display-block">Sexo:</label>
                                                                    <div class="col-sm-12 col-md-12">
                                                                        <label class="radio-inline">
                                                                            <input type="radio" id="rb_producto" name="n_sexo" value="M" class="styled" checked="checked">
                                                                            Masculino
                                                                        </label>
                                                                        <label class="radio-inline">
                                                                            <input type="radio" id="rb_familia" name="n_sexo" value="F" class="styled">
                                                                            Femenino
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <div class="form-group col-xs-12 col-sm-12 col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" name="n_telefono">
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-group col-xs-12 col-sm-6">
                                                                    ...
                                                                    <!-- <div class="content-group-lg"> -->
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="n_fnacimiento" class="form-control pickadate-accessibility">
                                                                        </div>
                                                                    <!-- </div> -->
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-xs-12 col-sm-6 col-md-4">
                                                                    ...
                                                                    <select class="select" id="iddepartamento" name="n_departamento">
                                                                        <?php
                                                                            $myrow = $obj->fetch_record("ubdepartamento");
                                                                ...
                                                                <div class="form-group col-xs-12 col-sm-6 col-md-4">
                                                                    ...
                                                                    <select class="select" id="idprovincia" name="n_provincia">
                                                                ...
                                                                <div class="form-group col-xs-12 col-md-12 col-md-4">
                                                                    ...
                                                                    <select class="select" id="iddistrito" name="n_distrito">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-xs-12 col-sm-6">
                                                                    ...
                                                                    <input type="text" class="form-control" name="n_documento">
                                                                </div>
                                                                <div class="form-group col-xs-12 col-sm-6">
                                                                    <label>Estado:</label>
                                                                    <select class="select" name="n_estado">
												...
												<fieldset>
													...
													<div class="collapse in" id="demo2" aria-expanded="true">
														...
														<table class="table datatable-basic">
															...
															<tbody>
                                                                 <?php
                                                                    $myrow = $obj->fetch_record("glb_persona");
                                                                    foreach ($myrow as $row) {
                                                                        //breaking point
                                                                        ?>
                                                                            <tr>
                                                                                ...
                                                                                <td><?php echo $row["perso_sexo"]; ?></td>
                                                                                <td><?php echo $row["perso_email"]; ?></td>
                                                                                <td>
                                                                                    <!--<a href="registrar_cliente.php?update=1&id=<?php echo $row["perso_id"]; ?>" class="btn btn-sm btn-info">Editar</a>-->
                                                                                    <a href="php/clases/cliente.php?delete=1&id=<?php echo $row["perso_id"]; ?>" class="btn btn-sm btn-danger">Eliminar</a>
                                                                                </td>
                                                                            </tr>
                                                                        <?php
                                                                    }
...
<script>
    $(function () {
       $("#iddepartamento").change(function () {
           ...
           $.ajax({
               type : 'POST',
               url : "php/clases/select.php",
               data :{
                   idprovincia:iddepartamento
               },
        ...
        $("#idprovincia").change(function () {
            ...
            $.ajax({
                type : 'POST',
                url : "php/clases/select1.php",
                data :{
                    iddistrito:idprovincia
                },
                success:function(data){
